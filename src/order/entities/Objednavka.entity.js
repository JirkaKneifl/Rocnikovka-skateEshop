class Objednavka {
  ...
  constructor(cislo, dat_prijeti, dat_expedice, zam_prijal, zam_zpracoval, zam_expedoval, jmeno, prijmeni, telefon, email, ulice, psc, mesto, Popis, Stav, celkovaCena, radekObjednavky) {
    this.cislo = cislo;
